...
python3 traffic_gen.py --threads 10 --duration 10 --replicas 64 --shards 1 --query direct --loop open --solrnum 16 --connections 1 --output-dir ./ --port 9111 --host 10.10.1.1 >/dev/null 2>&1 &
