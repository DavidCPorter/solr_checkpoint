#!/bin/bash
alias clearlog='cd ~/projects/solrcloud; pssh -l dporte7 -h ssh_files/pssh_traffic_node_file "echo ''>/var/solr/logs/solr_slow_requests.log"'
...
alias search='cd ~/projects/solrcloud;pssh -l dporte7 -h ssh_files/pssh_traffic_node_file -P "cat /var/solr/logs/solr_slow_requests.log"'
...
alias runsolrj='cd ~/projects/solrcloud;nohup pssh -i -h ssh_files/pssh_traffic_node_file -l dporte7 "cd solrclientserver;java -cp target/solrclientserver-1.0-SNAPSHOT.jar com.dporte7.solrclientserver.DistributedWebServer" > solrjoutput.txt &'
